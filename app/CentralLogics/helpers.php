...
//                }
    ...
    public static function text_variable_data_format($value,$user_name=null,$platform_name=null,$delivery_man_name=null,$transaction_id=null,$order_id=null)
    {
        $data = $value;
        if ($value) {
            if($user_name){
            ...
            if($platform_name){
                $data =  str_replace("{platformName}", $platform_name, $data);
            }
