...
class CustomerLogic{
    ...
    public static function add_to_wallet($customer_id, float $amount)
    {
        ...
        if ($wallet_transaction) {
            ...
            $platform_name = Helpers::get_business_settings('platform_name');
            $bonus_value = '';
            ...
            if ($bonus_amount > 0){
                ...
                if ($bonus_transaction){
                    ...
                    $bonus_value = Helpers::text_variable_data_format(value:$bonus_message, user_name: $customer->f_name. ' '. $customer->l_name, platform_name: $platform_name);
                }
            }
            ...
            $value = Helpers::text_variable_data_format(value:$message, user_name: $customer->f_name. ' '. $customer->l_name, platform_name: $platform_name);
