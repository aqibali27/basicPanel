...
class ConfigController extends Controller
{
    ...
    public function configuration(): JsonResponse
    {
        ...
        return response()->json([
            'platform_name' => $this->business_setting->where(['key' => 'platform_name'])->first()->value,
            'platform_open_time' => $this->business_setting->where(['key' => 'platform_open_time'])->first()->value,
            'platform_close_time' => $this->business_setting->where(['key' => 'platform_close_time'])->first()->value,
            'platform_schedule_time' => $schedules,
            'platform_logo' => $this->business_setting->where(['key' => 'logo'])->first()->value,
            'platform_address' => $this->business_setting->where(['key' => 'address'])->first()->value,
            'platform_phone' => $this->business_setting->where(['key' => 'phone'])->first()->value,
            'platform_email' => $this->business_setting->where(['key' => 'email_address'])->first()->value,
            'platform_location_coverage' => $this->branch->where(['id' => 1])->first(['longitude', 'latitude', 'coverage']),
            ...
            'base_urls' => [
                ...
                'platform_image_url' => asset('storage/app/public/platform'),
