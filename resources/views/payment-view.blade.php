                                ...
                                <div class="card-body" style="height: 70px">
                                    ...
                                    <!-- Note that the amount is in paise = 50 INR -->
                                        ...
                                        <script src="https://checkout.razorpay.com/v1/checkout.js"
                                                ...
                                                data-name="{{\App\Model\BusinessSetting::where(['key'=>'platform_name'])->first()->value}}"
                                                data-description="{{$order_amount}}"
                                                data-image="{{asset('storage/app/public/platform/'.\App\Model\BusinessSetting::where(['key'=>'logo'])->first()->value)}}"
