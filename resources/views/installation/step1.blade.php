...
@section('content')
    ...
    <div class="text-center text-white mb-4">
        <h2>Lawyer Software Installation</h2>
        <h6 class="fw-normal">Please proceed step by step with proper data according to instructions</h6>
    </div>

    <!-- Progress -->
    <div class="pb-2">
        <div class="progress cursor-pointer" role="progressbar" aria-label="Lawyer Software Installation"
    ...
    <div class="card mt-4">
        <div class="p-4 mb-md-3 mx-xl-4 px-md-5">
            <div class="d-flex justify-content-end mb-2">
                <a href="https://docs.6amtech.com/docs-Lawyer/intro" class="d-flex align-items-center gap-1"
                   target="_blank">
                    Read Documentation
