                            ...
                            <tr>
                                <td class="p-10">
                                    <span class="d-block text-center">
                                        ...
                                        <img class="mb-2 mail-img-2" onerror="this.src='{{ asset('storage/app/public/business/' . $platform_logo) }}'"
                                                            ...
                                                            <td colspan="2">
                                                                ...
                                                                <table class="w-100">
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td class="text-right p-1 px-3">{{ \App\CentralLogics\Helpers::format_currency($order->platform_discount_amount) }}</td>
                                                                    </tr>
                                                                    <tr>
                                                                        <td style="width: 40%"></td>
            ...
            <tr>
                <td>
                    ...
                    <span class="copyright" id="mail-copyright">
                        {{ $copyright_text?? translate('Copyright_2023_Lawyer._All_right_reserved') }}
                    </span>
                </td>
            </tr>
        </tbody>
