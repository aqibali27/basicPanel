...
<head>
    ...
    <link rel="icon" type="image/x-icon" href="{{ asset('storage/app/public/platform/' . $icon ?? '') }}">
    ...
    <div class="auth-wrapper">
        <div class="auth-wrapper-left">
            <div class="auth-left-cont">
                ...
                <img width="310" src="{{asset('storage/app/public/platform/'.$platform_logo)}}"
                            ...
                            <div class="row p-2">
                                ...
                                <div class="col-7 input-icons" class="bg-white rounded">
                                    <a onclick="javascript:re_captcha();">
                                        <img src="{{ URL('/admin/auth/code/captcha/1') }}" class="input-field" id="default_recaptcha_id" style="display: inline;width: 80%; height: 75%">
