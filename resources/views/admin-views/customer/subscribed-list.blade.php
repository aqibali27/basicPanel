                    ...
                    <table class="table table-hover table-borderless table-thead-bordered table-nowrap table-align-middle card-table">
                        ...
                        @foreach($newsletters as $key=>$newsletter)
                            <tr class="">
                                ...
                                <td>
                                    <a class="text-dark" href="mailto:{{$newsletter['email']}}?subject={{translate('Mail from '). \App\Model\BusinessSetting::where(['key' => 'platform_name'])->first()->value}}">{{$newsletter['email']}}</a>
                                </td>
