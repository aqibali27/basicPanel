<?php
$company_name = App\Model\BusinessSetting::where('key', 'store_name')->first()->value;
?>
                        ...
                        <tr>
                            <td class="p-10">
                                <span class="d-block text-center">
                                    @php($business_name_logo = \App\Model\BusinessSetting::where(['key'=>'logo'])->first()->value)
                                    <img class="mb-2 mail-img-2" onerror="this.src='{{ asset('storage/app/public/business_name/' . $business_name_logo) }}'"
        ...
        <tr>
            <td>
                ...
                <span class="copyright" id="mail-copyright">
                    {{ $data['copyright_text']?? translate('Copyright_2023_Lawyer._All_right_reserved') }}
                </span>
            </td>
        </tr>
    </tbody>
