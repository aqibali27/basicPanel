...
@section('content')
    ...
    @php($branch_count=\App\Model\Branch::count())
        ...
        <div class="row g-2">
            <div class="col-12">
                <form action="{{env('APP_MODE')!='demo'?route('admin.business-settings.store.update-location'):'javascript:'}}" method="post"
                            ...
                            <div class="row">
                                <div class="col-12 mb-4">
                                    <span class="badge-soft-danger px-2">
                                        {{translate('This location setup is for your Main branch. Carefully set your store location and coverage area. If you want to ignore the coverage area then keep the input box empty.')}}
                                ...
                                <div class="col-md-4 col-12">
                                    <div class="form-group">
                                        <label class="input-label" for="">
                                            ...
                                            data-toggle="tooltip"
                                            data-placement="top"
                                            title="{{translate('This value is the radius from your store location, and customer can order food inside  the circle calculated by this radius.')}}"></i>
