                        ...
                        <div class="col-md-4 col-sm-6">
                            <div class="form-group">
                                ...
                                <input type="text" value="{{$store_name}}"
                                       name="store_name" class="form-control" placeholder="{{translate('Ex: ABC Company')}}">
                            </div>
                        </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="text-center mt-3">
                                    <img style="height: 100px;border: 1px solid; border-radius: 10px;" id="viewer_2"
                                         onerror="this.src='{{asset('public/assets/admin/img/160x160/img2.jpg')}}'"
                                         src="{{asset('storage/app/public/store/'.$fav_icon)}}" alt="fav"/>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="col-sm-8">
                            <div class="form-group">
                                ...
                                <input type="text" value="{{$footer_text}}" name="footer_text" class="form-control"
                                       placeholder="{{translate('Ex: Copyright@Lawyer.com')}}" required>
                            </div>
                        </div>
